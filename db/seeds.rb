...
GameSession.create!(game: game4, creator: user2, city: "Bordeaux", description: "I pushed on master, what do I do now? Edit Asset/Javascript?!", date: Time.now + (2.1*7*24*60*60), price: 99, address: '35 rue du jardin public, Bordeaux')
GameSession.create!(game: game3, creator: user2, city: "Vierzon", description: "Git push Heroku master", date: Time.now + (2.3*7*24*60*60), price: 5, address: '12 rue andre ribaud, Vierzon')
GameSession.create!(game: game3, creator: user2, city: "Moncuq", description: "Hi guys, I'm searching for a pigeon to rent. Hello? Anybody?!", date: Time.now + (2.3*7*24*60*60), price: 66, address: '5 chemin des courtilles, Moncuq')
